...
To get the latest development version or RePlay, [install it from the GitHab repository][troubleshooting](https://sb-ai-lab.github.io/RePlay/pages/installation.html#development). 
